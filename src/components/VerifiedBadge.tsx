  ...
  return (
    <span className="relative inline-flex">
      <button
        ...
        className={cn(
          'cursor-pointer transition-all focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-1 rounded-full',
          className
        )}
            ...
            <div className="relative bg-white dark:bg-neutral-800 rounded-xl shadow-xl border border-[var(--peach-200)] dark:border-neutral-700 overflow-hidden">
              <div className="flex items-center gap-2.5 px-3.5 py-3">
                ...
                <p className="text-[13px] text-neutral-700 dark:text-neutral-300 leading-snug">
                  This is a <strong className="text-neutral-900 dark:text-neutral-100">verified account</strong>. Their identity has been confirmed.
                </p>
              </div>
            </div>
          </motion.div>
