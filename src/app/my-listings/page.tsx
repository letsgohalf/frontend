        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-neutral-500 mt-1">Manage your room listings</p>
            </div>
          </div>
          <button
          ...
          <div className="main-feed pb-24 lg:pb-8">
            ...
            >
              <div className="card-glass p-12 text-center">
                <div className="w-16 h-16 rounded-2xl bg-[var(--peach-100)] dark:bg-neutral-800 flex items-center justify-center mx-auto mb-4">
                  <Home className="w-8 h-8 text-[var(--peach-500)]" />
                </div>
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2">
                  No listings yet
                </h3>
                <p className="text-neutral-500 mb-6 max-w-sm mx-auto">
                  Create your first listing to start finding roommates or sharing your space.
                </p>
                <button
                  onClick={() => router.push('/create')}
