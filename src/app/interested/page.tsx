      ...
      <header className="header-web">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-500 mt-1">Listings you&apos;ve shown interest in</p>
          </div>
        </div>
      </header>
          ...
          <div className="main-feed pb-24 lg:pb-8">
            ...
            >
              <div className="card-glass p-12 text-center">
                <div className="w-16 h-16 rounded-2xl bg-[var(--pink-100)] dark:bg-neutral-800 flex items-center justify-center mx-auto mb-4">
                  <Heart className="w-8 h-8 text-[var(--pink-500)]" />
                </div>
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2">
                  No interests yet
                </h3>
                <p className="text-neutral-500 mb-6 max-w-sm mx-auto">
                  When you express interest in a listing, it will appear here so you can track your connections.
                </p>
                <button
